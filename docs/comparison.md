...
<div class="m8-callout m8-callout--orange">
  ...
  <div>
    ...
    <p>This is a positioning guide, not a quality ranking. Most tools below solve a different layer of the stack: they build, host, run, route, or automate agents. M8Shift only answers repository coordination and handoff ownership. Model labels are practical hints; check each product's current pricing and license page before adoption.</p>
  </div>
</div>

<div class="m8-tool-grid">
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-robot" aria-hidden="true"></i><h3><a href="https://openclaw.ai/">OpenClaw</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">paid cloud</span></h3><span class="m8-tool-verdict">No</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-diagram-project" aria-hidden="true"></i><h3><a href="https://docs.langchain.com/oss/python/langgraph/overview">LangGraph</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Partial</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-comments" aria-hidden="true"></i><h3><a href="https://github.com/microsoft/autogen">AutoGen</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Historical</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-sitemap" aria-hidden="true"></i><h3><a href="https://learn.microsoft.com/en-us/agent-framework/overview/">Microsoft Agent Framework</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Complementary</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-users-gear" aria-hidden="true"></i><h3><a href="https://docs.crewai.com/">CrewAI</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">paid plans</span></h3><span class="m8-tool-verdict">Partial</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-code" aria-hidden="true"></i><h3><a href="https://www.openhands.dev/">OpenHands</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">freemium cloud</span></h3><span class="m8-tool-verdict">Closest</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-cubes" aria-hidden="true"></i><h3><a href="https://developers.openai.com/api/docs/guides/agents">OpenAI Agents SDK</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">paid API</span></h3><span class="m8-tool-verdict">Complementary</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-layer-group" aria-hidden="true"></i><h3><a href="https://docs.dify.ai/en/home">Dify</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">paid cloud</span></h3><span class="m8-tool-verdict">No</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-shuffle" aria-hidden="true"></i><h3><a href="https://docs.n8n.io/advanced-ai/">n8n AI workflows</a><span class="m8-tool-model">source available</span><span class="m8-tool-model">paid cloud</span></h3><span class="m8-tool-verdict">No</span></header>
