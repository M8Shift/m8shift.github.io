...
| Markdown mirrors | `https://m8shift.ai/_markdown/<path>.md` | Every built page ships a plain-markdown mirror generated at build time (45 pages at this writing). Same content as the HTML, none of the chrome. Example: [`/_markdown/reference/cli.md`](https://m8shift.ai/_markdown/reference/cli.md) mirrors [`/reference/cli`](/reference/cli). |
