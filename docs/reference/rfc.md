...
| 037 | [Agent context compression backends](https://github.com/M8Shift/M8Shift/blob/main/docs/en/rfc/037-rfc-agent-context-compression-backends.md) | Digest-based context compression + optional backends | Phase D follow-up shipped | v3.40.0 · 2026-07-02 | builtin + RTK + explicit/opt-in `headroom_ext` |
