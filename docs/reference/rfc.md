...
| 048 | [Adoption discipline pack](https://github.com/M8Shift/M8Shift/blob/main/docs/en/rfc/048-rfc-adoption-discipline-pack-update-health.md) | Agent pack + adoption health diagnostics + future local update | **PR A implemented** | v3.49.0 · 2026-07-04 | `M8SHIFT.agent-pack.md`, compact anchor floor, adoption `doctor` findings; local `update --target --source` remains PR B / v3.50.0 |
