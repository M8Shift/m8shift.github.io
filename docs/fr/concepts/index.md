...
| [Relations](./relations) | Pourquoi le stylo passe-t-il d'un agent à l'autre ? | `ask` aujourd'hui ; vocabulaire spécifié |
| [Validation](./validation) | Le journal est-il fiable, et le travail est-il relu ? | Vérifications des entrées aujourd'hui ; revue spécifiée |
