...
<div class="m8-callout m8-callout--orange">
  ...
  <div>
    ...
    <p>Ce guide positionne les outils, il ne les classe pas en qualité. La plupart résolvent une autre couche de la pile : construire, héberger, exécuter, router ou automatiser des agents. M8Shift répond seulement à la coordination du dépôt et à la propriété des passations. Les labels de modèle sont des repères pratiques ; vérifiez la page pricing/licence actuelle de chaque produit avant adoption.</p>
  </div>
</div>

<div class="m8-tool-grid">
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-robot" aria-hidden="true"></i><h3><a href="https://openclaw.ai/">OpenClaw</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">cloud payant</span></h3><span class="m8-tool-verdict">Non</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-diagram-project" aria-hidden="true"></i><h3><a href="https://docs.langchain.com/oss/python/langgraph/overview">LangGraph</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Partiel</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-comments" aria-hidden="true"></i><h3><a href="https://github.com/microsoft/autogen">AutoGen</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Historique</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-sitemap" aria-hidden="true"></i><h3><a href="https://learn.microsoft.com/en-us/agent-framework/overview/">Microsoft Agent Framework</a><span class="m8-tool-model">open source</span></h3><span class="m8-tool-verdict">Complémentaire</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-users-gear" aria-hidden="true"></i><h3><a href="https://docs.crewai.com/">CrewAI</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">plans payants</span></h3><span class="m8-tool-verdict">Partiel</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-code" aria-hidden="true"></i><h3><a href="https://www.openhands.dev/">OpenHands</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">cloud freemium</span></h3><span class="m8-tool-verdict">Le plus proche</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-cubes" aria-hidden="true"></i><h3><a href="https://developers.openai.com/api/docs/guides/agents">OpenAI Agents SDK</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">API payante</span></h3><span class="m8-tool-verdict">Complémentaire</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-layer-group" aria-hidden="true"></i><h3><a href="https://docs.dify.ai/en/home">Dify</a><span class="m8-tool-model">open source</span><span class="m8-tool-model">cloud payant</span></h3><span class="m8-tool-verdict">Non</span></header>
  ...
  <article class="m8-tool-card">
    <header><i class="fa-solid fa-shuffle" aria-hidden="true"></i><h3><a href="https://docs.n8n.io/advanced-ai/">Workflows IA n8n</a><span class="m8-tool-model">source disponible</span><span class="m8-tool-model">cloud payant</span></h3><span class="m8-tool-verdict">Non</span></header>
