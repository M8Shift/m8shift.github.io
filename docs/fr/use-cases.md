...
<div class="m8-usecase-gallery">
  <a class="m8-usecase-image-card" href="#ecrire-un-livre">
    <img src="/use-cases/write-book.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-pen-fancy" aria-hidden="true"></i><strong>Écriture</strong></span>
      <span class="m8-usecase-image-card__text">Coordonner plan, rédaction, relecture, édition et nettoyage du manuscrit.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#construire-du-logiciel">
    <img src="/use-cases/build-software.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-terminal" aria-hidden="true"></i><strong>Logiciel</strong></span>
      <span class="m8-usecase-image-card__text">Séparer planification, implémentation, revue, tests, docs et notes de release.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#generer-de-la-documentation">
    ...
    <span class="m8-usecase-image-card__body">
      ...
      <span class="m8-usecase-image-card__text">Transformer des connaissances éparpillées en guides, références et onboarding.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#concevoir-un-site-web">
    <img src="/use-cases/website.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-layer-group" aria-hidden="true"></i><strong>Sites web</strong></span>
      <span class="m8-usecase-image-card__text">Coordonner architecture d'information, copy, docs, FAQ et contenus prêts à intégrer.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#creer-du-contenu-marketing-et-produit">
    ...
    <span class="m8-usecase-image-card__body">
      ...
      <span class="m8-usecase-image-card__text">Garder un message produit cohérent entre pages, annonces et comparaisons.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#recherche-et-synthese">
    <img src="/use-cases/research.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-magnifying-glass-chart" aria-hidden="true"></i><strong>Recherche</strong></span>
      <span class="m8-usecase-image-card__text">Collecter des sources, comparer des approches, identifier les risques et produire des notes.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#revue-et-controle-qualite">
    <img src="/use-cases/review.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i><strong>Revue</strong></span>
      <span class="m8-usecase-image-card__text">Séparer production et validation pour éviter qu'un agent soit seul approbateur.</span>
    </span>
  </a>
  <a class="m8-usecase-image-card" href="#automatiser-des-workflows-multi-etapes">
    <img src="/use-cases/automation.svg" alt="">
    <span class="m8-usecase-image-card__body">
      <span class="m8-usecase-image-card__title"><i class="fa-solid fa-gears" aria-hidden="true"></i><strong>Automatisation</strong></span>
      <span class="m8-usecase-image-card__text">Découper le travail en tours, suivre l'avancement, valider la sortie et finaliser proprement.</span>
    </span>
  </a>
</div>
