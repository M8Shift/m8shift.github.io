...
- **🗺️ On the design board** — parallel multi-session (RFC 038) remains future work;
  ...
  Phase 4 (default provider adapters) in `v3.56.0`; **adoption discipline and
  local update** (RFC 048) shipped across `v3.49.0` and `v3.50.0`; **project
  compartmentalization** (RFC 052) shipped its first slice (`doctor --hygiene`)
  in `v3.56.0`.
